...
| Expected max allowed mass density | 0.83 kg/L|

4. Draw a first quick design of a dual stage to assess minimum distances required between electrodes and general DOE
